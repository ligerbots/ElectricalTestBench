...
public class TestBench {
    ...
    double neo1Volt, neo2Volt, neo3Volt, neo4Volt, neo5Volt, neo6Volt, testVar; // Voltage of the individual neos
    ...
    public void runTestBench() {
        testVar = SmartDashboard.getNumber("Neo 1 Volt", 0);
        neo1.setVoltage(testVar);
        SmartDashboard.putNumber("testVar", testVar);
